...
{
  internal static class EstadoDeCuentaDeCombustible11
  {
    internal static bool Create(ElectronicDocument electronicDocument, out string fileName)
    {
      ...
      return Base.Save(electronicDocument, "EstadoDeCuentaDeCombustible11.xml", out fileName);
    }
  }
}