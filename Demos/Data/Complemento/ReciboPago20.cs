...
{
  public static class ReciboPago20
  {
    /// <summary>
    /// Este ejemplo carga los datos para el timbrado para un recibo de pago 2.0
    /// </summary>
    ...
    public static void CargarDatosTimbrado(ElectronicDocument electronicDocument)
    {
      ...
      ElectronicDocumentLibrary.Complemento.RecepcionPago.Data data = (ElectronicDocumentLibrary.Complemento.RecepcionPago.Data)electronicDocument.Data.Complementos.Last();
      ...
      DocumentoRelacionado documento = pago.DocumentosRelacionados.Add();
      ...
      TrasladoDocumento trasladoDocumento = documento.Impuestos.Traslados.Add();
      trasladoDocumento.Base.Value = 1000;
      trasladoDocumento.Impuesto.Value = "002";
      trasladoDocumento.TipoFactor.Value = "Tasa";
      trasladoDocumento.TasaCuota.Value = new decimal(0.160000);
      trasladoDocumento.TasaCuota.Decimals = 6;
      trasladoDocumento.Importe.Value = 160;

      ElectronicDocumentLibrary.Complemento.RecepcionPago.Impuesto impuesto = pago.Impuestos.Add();

      ElectronicDocumentLibrary.Complemento.RecepcionPago.Traslado traslado = impuesto.Traslados.Add();
    ...
    public static void CargarDatosCompleto(ElectronicDocument electronicDocument)
    {
      ...
      RetencionDocumento retencionDocumento = documento.Impuestos.Retenciones.Add();
      retencionDocumento.Base.Value = 1000;
      retencionDocumento.Impuesto.Value = "001";
      retencionDocumento.TipoFactor.Value = "Tasa";
      retencionDocumento.TasaCuota.Value = new decimal(0.160000);
      ...
      Retencion retencion = impuesto.Retenciones.Add();
