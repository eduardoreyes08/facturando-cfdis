...
namespace HyperSoft.Ejemplo.Data.Complemento.CartaPorte
{
  ...
  public static class Listas
  {
    ...
    private static void FillRegimenesAduaneros(RegimenesAduaneros data)
    {
      ...
      data.Add().RegimenAduanero.Value = "EXD";
    }
    ...
    private static void FillTransporteMaritimo(ElectronicDocumentLibrary.Complemento.CartaPorte.TransporteMaritimo data)
    {
      data.PermisoSct.Value = "TPAF01";
    ...
    private static void FillTransporteAereo(ElectronicDocumentLibrary.Complemento.CartaPorte.TransporteAereo data)
    {
      data.PermisoSct.Value = "TPAF01";
    ...
    private static void FillTransporteFerroviario(ElectronicDocumentLibrary.Complemento.CartaPorte.TransporteFerroviario data)
    {
