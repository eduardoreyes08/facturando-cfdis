...
namespace HyperSoft.Ejemplo.Data
{
  public static class Cfdi40
  {
    ...
    public static void CargarDatosTimbrado(ElectronicDocument electronicDocument)
    {
      ...
      Relacionados relacionados = electronicDocument.Data.CfdiRelacionadosExt.Add();
    ...
    public static void CargarDatosExtranjero(ElectronicDocument electronicDocument)
    {
      electronicDocument.Data.Clear();
      ...
      electronicDocument.Data.Folio.Value = "CFDI40146";
      electronicDocument.Data.FormaPago.Value = "01";
      electronicDocument.Data.LugarExpedicion.Value = "83000";
      electronicDocument.Data.MetodoPago.Value = "PUE";
      electronicDocument.Data.Moneda.Value = "MXN";
      electronicDocument.Data.Serie.Value = "Test_1";
      electronicDocument.Data.Fecha.Value = DateTime.Now.AddMinutes(-80);
      electronicDocument.Data.SubTotal.Value = 10;
      electronicDocument.Data.TipoComprobante.Value = "I";
      electronicDocument.Data.Total.Value = 10.32;
      // *************************************************************************************
    ...
    public static void CargarDatosCompleto(ElectronicDocument electronicDocument)
    {
      ...
      CfdiRelacionado cfdiRelacionado = relacionados.CfdiRelacionados.Add();
      ...
      // Cuenta predial del concepto
      CuentaPredial cuentaPredial = concepto.CuentasPrediales.Add();
    ...
    public static void CargarDatosListas(ElectronicDocument electronicDocument)
    {
      ...
      for (int i = 1; i <= 3; i++)
      {
        ...
        for (int j = 1; j <= 8; j++)
        {
          ...
          // Información aduanera de la parte del concepto
          for (int k = 1; k <= 9; k++)
            partida.InformacionAduanera.Add().Numero.Value = "21  24  1772  3000244";
          // *************************************************************************************
        }
      }
