...
{
  public static class Cfd22
  {
    public static void CargarDatosCfd(ElectronicDocument electronicDocument)
    {
      electronicDocument.Data.Clear();

      // Datos del comprobante ****************************************************************
      electronicDocument.Data.Version.Value = "2.2";
      ...
      // Datos del Receptor ********************************************************************
      electronicDocument.Data.Receptor.Rfc.Value = "AAAA010101AA1";
      ...
      electronicDocument.Data.Receptor.Domicilio.CodigoPostal.Value = "03100";
      // ***************************************************************************************
