...
#Region "Methods"
  ...
  Private Function GenerarTimbrar(ByRef fileName As String) As Boolean
    ...
    fileName = Path.Combine(Me._generationDirectory, "ReciboPago20_Timbrado.xml")

    ' Se agrega el complemento RECIBO DE PAGO
    ReciboPago20.CargarDatosTimbrado(Me._electronicDocument)

    ' Se timbra el recibo
    If ECodex.Timbrar(Me._electronicDocument) = False Then
      Return False
    End If
  ...
  Private Function GenerarXml(ByRef fileName As String) As Boolean
    fileName = Path.Combine(Me._generationDirectory, "ReciboPago20.xml")

    ' Se agrega el complemento RECIBO DE PAGO
    ReciboPago20.CargarDatosCompleto(Me._electronicDocument)
...
#Region "Methods"
  ...
  Private Sub btnExecute_Click(sender As Object, e As EventArgs) Handles btnExecute.Click
    ...
    Finally
      ...
      If generatedfile AndAlso Gui.ShowQuestion(String.Format("El RECIBO DE PAGO 2.0 fue generado con éxito.{0}{0}¿Deseas visualizarlo?", Environment.NewLine)) Then
