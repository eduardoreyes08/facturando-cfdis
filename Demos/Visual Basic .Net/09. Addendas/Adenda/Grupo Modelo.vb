...
Imports HyperSoft.ElectronicDocumentLibrary.GrupoModelo.Addenda

Friend NotInheritable Partial Class Adenda
	
	Friend Shared Function GrupoModelo(ByRef fileName As String) As Boolean
		'En este método se cargan los datos de la factura.
		Cfdi40.CargarDatosCompleto(electronicDocument)

		Dim addenda As GrupoModelo = HyperSoft.ElectronicDocumentLibrary.GrupoModelo.Addenda.GrupoModelo.NewEntity()
		...
		addenda.Data.RequestForPaymentIdentification.EntityType.Value = "FA"
		' FA = Factura y Nota de Cargo. AN = Anticipo. ND = Nota de Crédito x devolución. NA = Nota de Crédito por ajuste en precio. NE = Nota de Crédito por descuento. CO = factura de Mercancías en Consignación. 
		addenda.Data.RequestForPaymentIdentification.UniqueCreatorIdentification.Value = "12345678901234567"
		' Los primeros 17 caracteres del UUID
		' Se especifica que tipo de instrucciones comerciales son enviadas
		Dim specialInstruction As ElectronicDocumentLibrary.GrupoModelo.Addenda.Header.SpecialInstruction = addenda.Data.SpecialInstructionList.Add()
		...
		Dim referenceIdentification As ElectronicDocumentLibrary.GrupoModelo.Addenda.Header.ReferenceIdentification = addenda.Data.OrderIdentification.ReferenceIdentificationList.Add()
		...
		addenda.Data.Buyer.ContactInformation.PersonOrDepartmentName.Text.Value = "2007"
		' Número de sociedad
		...
		Dim nameAndAddress As ElectronicDocumentLibrary.GrupoModelo.Addenda.Header.NameAndAddress = addenda.Data.ShipTo.NameAndAddressList.Add()
		...
		Dim customs As ElectronicDocumentLibrary.GrupoModelo.Addenda.Lines.Customs = addenda.Data.CustomsList.Add()
		...
		Dim currency As ElectronicDocumentLibrary.GrupoModelo.Addenda.Header.Currency = addenda.Data.CurrencyList.Add()
		...
		Dim allowanceCharge As ElectronicDocumentLibrary.GrupoModelo.Addenda.Header.AllowanceCharge = addenda.Data.AllowanceChargeList.Add()
	  ...
	  For i As Integer = 0 To 2
			...
			Dim lineItem As ElectronicDocumentLibrary.GrupoModelo.Addenda.Lines.LineItem = addenda.Data.LineItemList.Add()
			...
			Dim alternateTradeItemIdentification As ElectronicDocumentLibrary.GrupoModelo.Addenda.Lines.AlternateTradeItemIdentification = lineItem.AlternateTradeItemIdentificationList.Add()
			...
			Dim aditionalQuantity As ElectronicDocumentLibrary.GrupoModelo.Addenda.Lines.AditionalQuantity = lineItem.AditionalQuantityList.Add()
			...
			Dim customsLine As ElectronicDocumentLibrary.GrupoModelo.Addenda.Lines.Customs = lineItem.CustomsList.Add()
			...
			Dim lotNumber As ElectronicDocumentLibrary.GrupoModelo.Addenda.Lines.LotNumber = lineItem.ExtendedAttributes.LotNumberList.Add()
			...
			Dim allowanceChargeLine As ElectronicDocumentLibrary.GrupoModelo.Addenda.Lines.AllowanceCharge = lineItem.AllowanceChargeList.Add()
			...
			Dim tradeItemTaxInformation As ElectronicDocumentLibrary.GrupoModelo.Addenda.Lines.TradeItemTaxInformation = lineItem.TradeItemTaxInformationList.Add()
		...
		Dim totalAllowanceCharge As ElectronicDocumentLibrary.GrupoModelo.Addenda.TotalAllowanceCharge = addenda.Data.TotalAllowanceChargeList.Add()
		...
		Dim tax As ElectronicDocumentLibrary.GrupoModelo.Addenda.Tax = addenda.Data.TaxList.Add()
		tax.Type.Value = "VAT"
		...
		Return Save("Addenda_Grupo_Modelo.xml", fileName)
	End Function
