...
Imports HyperSoft.ElectronicDocumentLibrary.Volkswagen.Addenda

Friend NotInheritable Partial Class Adenda

  Friend Shared Function Volkswagen(ByRef fileName As String) As Boolean
		'En este método se cargan los datos de la factura.
		Cfdi40.CargarDatosCompleto(electronicDocument)

		Dim addenda As Volkswagen = New HyperSoft.ElectronicDocumentLibrary.Volkswagen.Addenda.Volkswagen()
		...
		Dim archivo As Archivo = addenda.Data.Archivos.Add()
		...
		Return Save("Addenda_Volkswagen.xml", fileName)
	End Function
