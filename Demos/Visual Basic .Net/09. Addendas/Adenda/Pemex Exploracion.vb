...
Friend NotInheritable Partial Class Adenda
  ...
  Friend Shared Function PemexExploracion(ByRef fileName As String) As Boolean
		'En este método se cargan los datos de la factura.
		Cfdi40.CargarDatosCompleto(electronicDocument)

		Dim addenda As New PemexExploracion()
		...
		Return Save("Addenda_PemexExploracion.xml", fileName)
	End Function
