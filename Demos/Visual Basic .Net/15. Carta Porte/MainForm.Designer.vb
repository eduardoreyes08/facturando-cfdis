...
Partial Class MainForm
  ...
  Private Sub InitializeComponent()
    ...
    Me.cmbOperacion.Items.AddRange(New Object() {"Generar y timbrar una carta porte 3.0", "Generar un XML de una carta porte 3.0"})
    ...
    Me.Text = "CARTA PORTE 3.1 - CFDI 4.0"
