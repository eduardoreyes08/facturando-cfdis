...
#Region "Methods"
  ...
  Private Function Cfdi40(ByRef fileName As String) As Boolean
    fileName = Path.Combine(Me._generationDirectory, "CFDI40.xml")

    'En este método se cargan los datos de la factura.
    Data.Cfdi40.CargarDatosCompleto(Me._electronicDocument)
  ...
  Private Sub btnExecute_Click(sender As Object, e As EventArgs) Handles btnExecute.Click
    ...
    Try
      Select Case Me.pgcInformacion.SelectedIndex
        Case 0
          generatedfile = Me.Cfdi40(fileName)
          Exit Select
        Case Else
    ...
    Finally
      ...
      If generatedfile AndAlso Gui.ShowQuestion(String.Format("El CFDI 4.0 fue generado con éxito.{0}{0}¿Deseas visualizarlo?", Environment.NewLine)) Then
