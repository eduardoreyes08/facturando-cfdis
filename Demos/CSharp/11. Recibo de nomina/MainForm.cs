...
namespace HyperSoft.Ejemplo.ReciboNomina
{
  public partial class MainForm : Form
  {
    ...
    /// <summary>
    /// Método para generar y timbrar un recibo de nómina 1.2
    /// </summary>
    /// <param name="fileName"></param>
    /// <returns></returns>
    private bool GenerarTimbrar(out string fileName)
    {
      fileName = Path.Combine(this.generationDirectory, "ReciboNomina12_Timbrado.xml");
    ...
    /// <summary>
    /// Método para generar el XML de un recibo de nómina 1.2
    /// </summary>
    /// <param name="fileName"></param>
    /// <returns></returns>
    private bool GenerarXml(out string fileName)
    {
      fileName = Path.Combine(this.generationDirectory, "ReciboNomina12.xml");

      //En este método se cargan los datos del recibo de nómina.
      Data.Complemento.Nomina12.CargarDatosCompleto(this.electronicDocument);
    ...
    private void btnExecute_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        {
          // Se genera el recibo de nómina y timbra
          case 0:
            generatedfile = this.GenerarTimbrar(out fileName);
            break;

          // Se genera el archivo XML de un recibo de nómina
          case 1:
      ...
      finally
      {
        ...
        if (generatedfile && Gui.ShowQuestion(string.Format("El RECIBO DE NOMINA fue generado con éxito.{0}{0}Desea visualizarlo ?", Environment.NewLine)))
