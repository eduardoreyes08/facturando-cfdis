namespace HyperSoft.Ejemplo.CartaPorte
{
  partial class MainForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.pnlOperaciones.TabIndex = 7;
      // 
      // btnTimbrado
      // 
      ...
      this.cmbOperacion.Items.AddRange(new object[] {
            "Generar y timbrar una carta porte",
            "Generar un XML de una carta porte"});
      ...
      this.pgcDescription.TabIndex = 8;
      // 
      // tshDescription
      // 
      ...
      this.Text = "CARTA PORTE 3.1 - CFDI 4.0";
