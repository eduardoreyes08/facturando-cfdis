...
using HyperSoft.ElectronicDocumentLibrary.Oxxo.Addenda;

namespace HyperSoft.Ejemplo.Adendas
{
  internal static partial class Adenda
  {
    internal static bool Oxxo(out string fileName)
    {
      //En este método se cargan los datos de la factura.
      Cfdi40.CargarDatosCompleto(electronicDocument);

      Oxxo addenda = HyperSoft.ElectronicDocumentLibrary.Oxxo.Addenda.Oxxo.NewEntity();
      ...
      ElectronicDocumentLibrary.Oxxo.Addenda.Detalle detalle = addenda.Data.Articulos.Add();
      ...
      return Save("Addenda_Oxxo.xml", out fileName);
    }
  }
}