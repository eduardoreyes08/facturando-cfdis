...
using HyperSoft.ElectronicDocumentLibrary.Amis.Addenda;

namespace HyperSoft.Ejemplo.Adendas
{
  internal static partial class Adenda
  {
    internal static bool Amis(out string fileName)
    {
      //En este método se cargan los datos de la factura.
      Cfdi40.CargarDatosCompleto(electronicDocument);

      Amis addenda = HyperSoft.ElectronicDocumentLibrary.Amis.Addenda.Amis.NewEntity();
      ...
      CodigoExterno codigoExterno = addenda.Data.Documento.Encabezado.Emisor.CodigosExternos.Add();
      ...
      Contacto contacto = addenda.Data.Documento.Encabezado.Emisor.Contactos.Add();
      ...
      TotalSubMonto totalSubMonto = addenda.Data.Documento.Encabezado.Totales.TotalesSubMonto.Add();
      ...
      #region Impuestos
      Impuesto impuesto = addenda.Data.Documento.Encabezado.Impuestos.Add();
      ...
      #region Retenciones
      Impuesto retencion = addenda.Data.Documento.Encabezado.Retenciones.Add();
      ...
      DocumentoReferencia documentoReferencia = addenda.Data.Documento.Encabezado.Aduana.DocumentosReferencia.Add();
      ...
      ElectronicDocumentLibrary.Amis.Addenda.Detalle detalle = addenda.Data.Documento.Detalles.Add();

      detalle.NumeroLinea.Value = 1;

      Codigo codigo = detalle.Codigos.Add();
      ...
      SubQtyItem item = detalle.SubQtyItems.Add();
      ...
      SubImporte subDescuento = detalle.SubDescuentos.Add();
      ...
      SubImporte subRecargo = detalle.SubRecargos.Add();
      ...
      SubMonto subMonto = detalle.SubMontos.Add();
      ...
      Aduana aduana = detalle.Aduanas.Add();
      ...
      DocumentoReferencia documentosReferencia = aduana.DocumentosReferencia.Add();
      ...
      Seccion seccion = detalle.Local.Secciones.Add();
      ...
      DescuentoRecargoGlobal descuentoRecargoGlobal = addenda.Data.Documento.DescuentoRecargoGlobales.Add();
      ...
      #region Referencia
      Referencia referencia = addenda.Data.Documento.Referencias.Add();
      ...
      SubCodigo subCodigo = referencia.SubCodigos.Add();
      subCodigo.Tipo.Value = "Tipo";
      subCodigo.Folio.Value = "1";
      subCodigo.Fecha.Value = DateTime.Now;

      MontoReferencia monto = referencia.Montos.Add();
      ...
      CampoString campoString = addenda.Data.Personalizados.CamposString.Add();
      campoString.Nombre.Value = "A";
      campoString.Campo.Value = "1";

      CampoNumero campoNumero = addenda.Data.Personalizados.CamposNumero.Add();
      campoNumero.Nombre.Value = "B";
      campoNumero.Campo.Value = 1;

      CampoFecha campoFecha = addenda.Data.Personalizados.CamposFecha.Add();
      campoFecha.Nombre.Value = "C";
      campoFecha.Campo.Value = DateTime.Now;

      CustomDetalle customDetalle = addenda.Data.Personalizados.CustomDetalles.Add();
      ...
      return Save("Addenda_Amis.xml", out fileName);
    }
  }
}