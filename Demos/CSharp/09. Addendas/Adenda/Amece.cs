...
using HyperSoft.ElectronicDocumentLibrary.Amece.Addenda;
using HyperSoft.ElectronicDocumentLibrary.Amece.Addenda.Header;
using HyperSoft.ElectronicDocumentLibrary.Amece.Addenda.Lines;
using AllowanceCharge = HyperSoft.ElectronicDocumentLibrary.Amece.Addenda.Lines.AllowanceCharge;

namespace HyperSoft.Ejemplo.Adendas
{
  internal static partial class Adenda
  {
    internal static bool Amece(out string fileName)
    {
      //En este método se cargan los datos de la factura.
      Cfdi40.CargarDatosCompleto(electronicDocument);

      Amece addenda = HyperSoft.ElectronicDocumentLibrary.Amece.Addenda.Amece.NewEntity();
      ...
      ElectronicDocumentLibrary.Amece.Addenda.Header.SpecialInstruction specialInstruction = addenda.Data.SpecialInstructionList.Add();
      ...
      ElectronicDocumentLibrary.Amece.Addenda.Header.ReferenceIdentification referenceIdentification = addenda.Data.OrderIdentification.ReferenceIdentificationList.Add();
      ...
      NameAndAddress nameAndAddress = addenda.Data.ShipTo.NameAndAddressList.Add();
      ...
      ElectronicDocumentLibrary.Amece.Addenda.Lines.Customs customs = addenda.Data.CustomsList.Add();
      ...
      ElectronicDocumentLibrary.Amece.Addenda.Header.Currency currency = addenda.Data.CurrencyList.Add();
      ...
      ElectronicDocumentLibrary.Amece.Addenda.Header.AllowanceCharge allowanceCharge = addenda.Data.AllowanceChargeList.Add();
      ...
      for (int i = 1; i <= 2; i++)
      {
        ...
        LineItem lineItem = addenda.Data.LineItemList.Add();
        ...
        ElectronicDocumentLibrary.Amece.Addenda.Lines.Customs customsLine = lineItem.CustomsList.Add();
        ...
        AllowanceCharge allowanceChargeLine = lineItem.AllowanceChargeList.Add();
      ...
      ElectronicDocumentLibrary.Amece.Addenda.TotalAllowanceCharge totalAllowanceCharge = addenda.Data.TotalAllowanceChargeList.Add();
      ...
      ElectronicDocumentLibrary.Amece.Addenda.Tax tax = addenda.Data.TaxList.Add();
      tax.Type.Value = "VAT";
      tax.Amount.Value = 15; tax.Percentage.Value = 5;
      ...
      return Save("Addenda_Amece.xml", out fileName);
    }
  }
}