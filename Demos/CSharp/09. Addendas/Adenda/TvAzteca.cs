...
using HyperSoft.ElectronicDocumentLibrary.TvAzteca.Addenda;

namespace HyperSoft.Ejemplo.Adendas
{
  internal static partial class Adenda
  {
    internal static bool TvAzteca(out string fileName)
    {
      //En este método se cargan los datos de la factura.
      Cfdi40.CargarDatosCompleto(electronicDocument);

      TvAzteca addenda = HyperSoft.ElectronicDocumentLibrary.TvAzteca.Addenda.TvAzteca.NewEntity();
      ...
      ElectronicDocumentLibrary.TvAzteca.Addenda.Cuerpo cuerpo = addenda.Data.Encabezado.Detalles.Add();
      ...
      return Save("Addenda_TvAzteca.xml", out fileName);
    }
  }
}