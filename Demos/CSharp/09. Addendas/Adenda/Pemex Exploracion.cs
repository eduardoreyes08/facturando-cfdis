...
namespace HyperSoft.Ejemplo.Adendas
{
  ...
  {
    internal static bool PemexExploracion(out string fileName)
    {
      //En este método se cargan los datos de la factura.
      Cfdi40.CargarDatosCompleto(electronicDocument);

      PemexExploracion addenda = new PemexExploracion();
      ...
      return Save("Addenda_PemexExploracion.xml", out fileName);
    }
  }
}