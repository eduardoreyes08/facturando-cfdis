...
using HyperSoft.ElectronicDocumentLibrary.Santander.Addenda;

namespace HyperSoft.Ejemplo.Adendas
{
  internal static partial class Adenda
  {
    internal static bool Santander(out string fileName)
    {
      //En este método se cargan los datos de la factura.
      Cfdi40.CargarDatosCompleto(electronicDocument);

      Santander addenda = HyperSoft.ElectronicDocumentLibrary.Santander.Addenda.Santander.NewEntity();

      // Elemento para Información de Pago.
      ElectronicDocumentLibrary.Santander.Addenda.InformacionPago informacionPago = addenda.Data.InformacionPagos.Add();
      ...
      InformacionFactoraje informacionFactoraje = addenda.Data.InformacionEmision.Factoraje.Add();
      ...
      CampoAdicional campoAdicional = addenda.Data.CamposAdicionales.Add();
      ...
      return Save("Addenda_Santander.xml", out fileName);
    }
  }
}