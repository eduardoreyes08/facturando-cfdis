...
using HyperSoft.ElectronicDocumentLibrary.Fuller.Addenda;

namespace HyperSoft.Ejemplo.Adendas
{
  internal static partial class Adenda
  {
    internal static bool Fuller(out string fileName)
    {
      //En este método se cargan los datos de la factura.
      Cfdi40.CargarDatosCompleto(electronicDocument);

      Fuller addenda = HyperSoft.ElectronicDocumentLibrary.Fuller.Addenda.Fuller.NewEntity();
      ...
      ElectronicDocumentLibrary.Fuller.Addenda.Detalle detalle = addenda.Data.Detalles.Add();
      ...
      return Save("Addenda_Fuller.xml", out fileName);
    }
  }
}