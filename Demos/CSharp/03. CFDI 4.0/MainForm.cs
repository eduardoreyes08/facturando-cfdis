...
namespace HyperSoft.Ejemplo.Cfdi40
{
  public partial class MainForm : Form
  {
    ...
    /// <summary>
    /// Método para generar un CFDI 4.0
    /// </summary>
    /// <param name="fileName"></param>
    /// <returns></returns>
    private bool Cfdi40(out string fileName)
    {
      fileName = Path.Combine(this.generationDirectory, "CFDI40.xml");

      //En este método se cargan los datos de la factura.
      Data.Cfdi40.CargarDatosCompleto(this.electronicDocument);
    ...
    private void ConfigurateControls()
    {
      ...
      Gui.MessageBoxCaption = "CFDI 4.0";
    ...
    private void btnExecute_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        {
          case 0:
            generatedfile = this.Cfdi40(out fileName);
            break;
      ...
      finally
      {
        ...
        if (generatedfile && Gui.ShowQuestion(string.Format("El CFDI 4.0 fue generado con éxito.{0}{0}¿Deseas visualizarlo?", Environment.NewLine)))
