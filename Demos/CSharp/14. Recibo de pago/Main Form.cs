...
namespace HyperSoft.Ejemplo.ReciboPago
{
  public partial class MainForm : Form
  {
    ...
    /// <summary>
    /// Método para generar y timbrar un recibo de pago 2.0
    /// </summary>
    /// <param name="fileName"></param>
    /// <returns></returns>
    private bool GenerarTimbrar(out string fileName)
    {
      fileName = Path.Combine(this.generationDirectory, "ReciboPago20_Timbrado.xml");

      //En este método se cargan los datos del recibo de pago.
    ...
    /// <summary>
    /// Método para generar el XML de un recibo de pago 2.0
    /// </summary>
    /// <param name="fileName"></param>
    /// <returns></returns>
    private bool GenerarXml(out string fileName)
    {
      fileName = Path.Combine(this.generationDirectory, "ReciboPago20.xml");

      // Se agrega el complemento RECIBO DE PAGO
      Data.Complemento.ReciboPago20.CargarDatosCompleto(this.electronicDocument);
    ...
    private void ConfigurateControls()
    {
      ...
      Gui.MessageBoxCaption = "Recibo de pago";
    ...
    private void btnExecute_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        {
          // Se genera el recibo de pago y se timbra
          case 0:
            generatedfile = this.GenerarTimbrar(out fileName);
            break;

          // Se genera el archivo XML de un recibo de pago
          case 1:
      ...
      finally
      {
        ...
        if (generatedfile && Gui.ShowQuestion(string.Format("El RECIBO DE PAGO fue generado con éxito.{0}{0}¿Desea visualizarlo?", Environment.NewLine)))
